  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        <div className='flex-1 flex justify-start items-center gap-3 cursor-pointer' onClick={visitProfile}>
        ...
        <div className="copy_btn" >
          <Image alt='copy_btn' src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} width={12} height={12} onClick={handleCopy} />
        </div>
      </div>
